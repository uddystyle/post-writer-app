    ...
    <>
      <section className="pt-6 md:pt-10 lg:py-32 pb-8 md:pb-12">
        <div className="container text-center flex flex-col items-center gap-4 max-w-[64rem]">
          ...
          <p className="text-muted-foreground sm:text-xl sm:leading-8 leading-normal max-w-[42rem]">
            このアプリケーションはNext.js
      ...
      >
        <div className="flex flex-col items-center text-center space-y-4 max-w-[58rem] mx-auto">
          <h2 className="font-extrabold text-3xl sm:text-3xl md:text-6xl">
            サービスの特徴
          </h2>
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
            このプロジェクトはモダンな技術スタックを使って作られたWebアプリケーションです。Next.js
            AppRouterやcontatelayerを利用してマークダウン形式でブログ投稿が出来ます。
          </p>
        </div>
